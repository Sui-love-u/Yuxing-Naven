...
import api.events.gal.yuxing.yuzusoft.murasame.naven.EventTarget;
import impl.events.gal.yuxing.yuzusoft.murasame.naven.EventPacket;
import impl.events.gal.yuxing.yuzusoft.murasame.naven.EventWorldUnload;
...
public class PacketManager {
    ...
    @SuppressWarnings("unused")
    @EventTarget
    public void onWorldLoad(EventWorldUnload event) {
        sequence = 0;
        clear(blinkFlag);
    }
