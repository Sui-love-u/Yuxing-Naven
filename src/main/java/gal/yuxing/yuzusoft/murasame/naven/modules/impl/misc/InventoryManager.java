...
import gal.yuxing.yuzusoft.murasame.naven.modules.impl.move.Scaffold;
import gal.yuxing.yuzusoft.murasame.naven.utils.TimeHelper;
import gal.yuxing.yuzusoft.murasame.naven.utils.ViaUtils;
...
public class InventoryManager extends Module {
    ...
    public void onPreUpdate(EventMotion event) {
        if (event.getType() == EventType.PRE) {
            ...
            //   return;
            // }
            if (Naven.getInstance().getModuleManager().getModule(AutoGapple.class).isEnabled()) return;
