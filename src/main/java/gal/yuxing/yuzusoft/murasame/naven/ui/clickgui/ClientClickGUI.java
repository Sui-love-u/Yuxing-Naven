package gal.yuxing.yuzusoft.murasame.naven.ui.clickgui;
...
//                clickOpenModuleSettings = false;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (selectedCategory == null) {
            widthAnimation.target = font30.getStringWidth(/*Naven.CLIENT_DISPLAY_NAME*/"NAVEN.TODAY") + 10;;
        ...
        font30.drawCenteredString(/*Naven.CLIENT_DISPLAY_NAME*/"NAVEN.TODAY", windowX + 47 + 8, windowY + 5, Colors.getColor(255, 255, 255, (int) (259 - titleAnimation.value)));
