...
import static gal.yuxing.yuzusoft.murasame.naven.ui.watermark.NavenWatermark.bodyColor;
import static gal.yuxing.yuzusoft.murasame.naven.ui.watermark.NavenWatermark.headerColor;
...
public class Scaffold extends Module {
    ...
    FloatValue sprintTicks = ValueBuilder.create(this, "Sprint Ticks").setDefaultFloatValue(2).setMaxFloatValue(3).setMinFloatValue(1).setFloatStep(1).setVisibility(() -> isCurrentMode("Telly Bridge")).build().getFloatValue();
