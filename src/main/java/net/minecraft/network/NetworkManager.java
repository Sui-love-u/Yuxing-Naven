...
import gal.yuxing.yuzusoft.murasame.naven.events.impl.EventDispatchPacket;
import gal.yuxing.yuzusoft.murasame.naven.events.impl.EventGlobalPacket;
import gal.yuxing.yuzusoft.murasame.naven.events.impl.EventHigherPacketSend;
...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
    ...
    public void sendUnregisteredPacket(final Packet packetIn) {
        ...
        Naven.getInstance().getEventManager().call(higherPacketSend);
