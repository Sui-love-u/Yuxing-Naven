...
import gal.yuxing.yuzusoft.murasame.naven.events.impl.EventJump;
import gal.yuxing.yuzusoft.murasame.naven.events.impl.EventMotionCalculate;
import gal.yuxing.yuzusoft.murasame.naven.modules.impl.combat.AutoGapple;
import gal.yuxing.yuzusoft.murasame.naven.modules.impl.move.NoJumpDelay;
import gal.yuxing.yuzusoft.murasame.naven.modules.impl.move.NoLiquid;
import gal.yuxing.yuzusoft.murasame.naven.modules.impl.render.BlockAnimation;
import gal.yuxing.yuzusoft.murasame.naven.modules.impl.render.FullBright;
...
public abstract class EntityLivingBase extends Entity {
    ...
    public void moveEntityWithHeading(float strafe, float forward) {
        if (this == Minecraft.getMinecraft().thePlayer) {
            if (Naven.getInstance().getModuleManager().getModule(AutoGapple.class).isEnabled()) {
